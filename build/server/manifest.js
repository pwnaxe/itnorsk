...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-CsjBIYrs.js')),
			__memo(() => import('./chunks/1-B4hYDQ2J.js')),
			__memo(() => import('./chunks/3-C0-TiIg6.js'))
		],
		routes: [
			{
				id: "/components",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-LcuZzjRM.js'))
			},
			{
				id: "/contact",
				pattern: /^\/contact\/?$/,
