...
import {
  ...
  useActions
} from "./chunk-GSQ3XILN.js";
import "./chunk-YN5USATH.js";
import "./chunk-VE4KAEWV.js";
import "./chunk-PSANW42J.js";
import {
  readable
} from "./chunk-2IUF53ZM.js";
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(header, file, 9, 0, 217);
    },
...
function instance_1($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    $$invalidate(9, instance4 = getInstance());
    instance4.init();
    return () => {
      instance4.destroy();
    };
  ...
  function addStyle(name, value) {
    if (internalStyles[name] != value) {
      if (value === "" || value == null) {
        ...
        $$invalidate(12, internalStyles), $$invalidate(20, oldVariant), $$invalidate(4, variant), $$invalidate(9, instance4);
      } else {
  ...
  function handleTargetScroll() {
    if (instance4) {
      instance4.handleTargetScroll();
      if (variant === "short") {
        $$invalidate(0, collapsed = "isCollapsed" in instance4 && instance4.isCollapsed);
      }
    }
  }
  ...
  const resize_handler = () => variant !== "short" && variant !== "fixed" && instance4 && instance4.handleWindowResize();
  ...
  const SMUITopAppBarIconButton_nav_handler = () => instance4 && instance4.handleNavigationClick();
  $$self.$$set = ($$new_props) => {
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("instance" in $$props)
      $$invalidate(9, instance4 = $$new_props.instance);
  ...
  $$self.$$.update = () => {
    ...
    1049104) {
      $:
        if (oldVariant !== variant && instance4) {
    ...
    528) {
      $:
        if (instance4 && variant === "short" && "setAlwaysCollapsed" in instance4) {
          instance4.setAlwaysCollapsed(alwaysCollapsed);
        }
    }
